...
<body>
    ...
    <div class="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative" data-dot="<img src='{{ url('frontend/img/carousel-1.jpg') }}'>">
            ...
            <div class="owl-carousel-item position-relative" data-dot="<img src='{{ url('frontend/img/carousel-2.jpg') }}'>">
            ...
            <div class="owl-carousel-item position-relative" data-dot="<img src='{{ url('frontend/img/carousel-3.jpg') }}'>">
...
@include('frontend.project_page')
@include('frontend.team_page')
@include('frontend.appointment_page')
